...
description: >
  Create agent company packages conforming to the Moontower Organization specification.
  Use when a user wants to create a new agent company from
  ...
  is already running in Paperclip or Moontower.
---
...
- For companies generated from a repo, add a references footer at the bottom of COMPANY.md body:
  `Generated from [repo-name](repo-url) with the company-creator skill from [Moontower](https://github.com/obe711/moontower-agents)`
...
- Citations and references: link to the source repo (if from-repo), link to the Agent Companies spec (https://agentcompanies.io/specification), and link to Moontower (https://github.com/obe711/moontower-agents)
